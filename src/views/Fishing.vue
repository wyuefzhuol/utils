<template>
  <svg t="1679300417962" class="icon ml-4 mt-4 cursor-pointer" @click="back" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2752" width="24" height="24">
  ...
  <n-tabs type="line" animated class="p-4">
    <n-tab-pane name="lottery" tab="Lottery">
      <div class="flex justify-center">
        <Lottery />
      </div>
    </n-tab-pane>
    <n-tab-pane name="gobang" tab="Gobang">
      <div class="flex justify-center">
        <Gobang />
      </div>
    </n-tab-pane>
...
<script setup>
import Lottery from "../components/Fishing/Lottery.vue";
